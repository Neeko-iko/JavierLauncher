...
class Ui_Main(object):
    def setupUi(self, Main):
        ...
        self.stackedWidget.setGeometry(QRect(0, 0, 495, 545))
        ...
        self.normallabel = QLabel(self.page)
        ...
        self.safemodecheck = QCheckBox(self.page)
        ...
        self.jarguicheck = QCheckBox(self.page)
